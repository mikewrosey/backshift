...
import RpnToJexlConverter from './RpnToJexlConverter'
import RrdGraphVisitor from './RrdGraphVisitor'

const RrdGraphConverter = {
...
export default Object.assign(RrdGraphVisitor, RrdGraphConverter)
